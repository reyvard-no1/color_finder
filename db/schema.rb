...
ActiveRecord::Schema[8.0].define(version: 2026_03_06_175632) do
  ...
  create_table "palettes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["collection_id"], name: "index_palettes_on_collection_id"
  ...
  add_foreign_key "palettes", "collections"
